    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h5>
                        <i class="fas fa-minus-circle"></i> Disminución de Stock
                    </h5>
                </div><!-- /.col -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('generardisminucion') }}"  role="form" enctype="multipart/form-data">
                                @csrf
