...
class ReportesxPersonaSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithHeadingRow, WithDrawings, WithTitle
{
    ...
    {
        return StockMovimiento::devolverReportexPersona ( $this->fechaDesde,$this->fechaHasta,  $this->comercio , $this->persona );
