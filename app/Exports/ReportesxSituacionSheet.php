...
class ReportesxSituacionSheet  implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithHeadingRow, WithDrawings, WithTitle
{
    ...
    {
        return StockMovimiento::devolverReportexSituacion ( $this->fechaDesde,$this->fechaHasta,  $this->comercio , $this->persona );
