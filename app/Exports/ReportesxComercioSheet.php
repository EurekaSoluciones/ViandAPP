...
class ReportesxComercioSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithHeadingRow, WithDrawings, WithTitle
{
    ...
    {
        return StockMovimiento::devolverReportexComercio ( $this->fechaDesde,$this->fechaHasta,  $this->comercio , $this->persona );
